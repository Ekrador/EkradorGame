...
function Inventory:render(x, y)
    ...
    if self.visible then
        ...
        love.graphics.print('Available points: '..tostring(self.player.bonusPoints),gFonts['small'], math.floor(x + 76), math.floor(y + 110))
        love.graphics.print('Strength: '..tostring(self.player.strength),gFonts['small'], math.floor(x + 66), math.floor(y + 122))
        love.graphics.print('Agility:    '..tostring(self.player.agility),gFonts['small'], math.floor(x + 66), math.floor(y + 134))
        love.graphics.print('Intelligence: '..tostring(self.player.intelligence),gFonts['small'], math.floor(x + 66), math.floor(y + 145))
        love.graphics.print(tostring(self.energy)..' regeneration: '..tostring(self.player.regenEnergy),gFonts['small'], math.floor(x + 66), math.floor(y + 156))
