...
function TalentTree:update(dt)
        for i = 1 , #self.player.spells do
            if self.points > 0 then
                if love.mouse.wasPressed(1) and (mx > self.player.spells[i].x and mx < self.player.spells[i].x + 15) and self.spells[i].playerCanImprove > 0
    ...
    for i = 1 , #self.player.spells do
        ...
        and (my > self.player.spells[i].y and my < self.player.spells[i].y + 15) then
            ...
            if self.player.spells[i].duration > 0 then
                love.graphics.print('duration: '..tostring(self.player.spells[i].duration), gFonts['small'], x, y)
                y = y + 10
            end
            ...
            love.graphics.print('cooldown: '..tostring(self.player.spells[i].cooldown), gFonts['small'], x, y)
            y = y + 10
